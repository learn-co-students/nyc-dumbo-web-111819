...
- [ ] Create a User class. The class should have these methods:
  ...
  - [ ] `User#username` returns a string for the username. Should not be able to change after the user is created.
  - [ ] `User#bio` returns a short biography for the user. Should be able to change after the user is created.
